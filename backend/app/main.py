...
app.add_middleware(
    ...
    # LAN (tótem) y sitios Netlify del frontend en producción.
    allow_origin_regex=(
...
app.include_router(analysis_jobs.router, prefix=settings.api_prefix)
app.include_router(analysis_email.router, prefix=settings.api_prefix)
